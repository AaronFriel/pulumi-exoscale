...
import (
	...
	"github.com/pulumi/pulumi-exoscale/provider/pkg/version"
)
...
func preConfigureCallback(vars resource.PropertyMap, c shim.ResourceConfig) error {
	...
	// _, err := stringValue(vars, "token", []string{"EXOSCALE_TOKEN"})
...
func Provider() tfbridge.ProviderInfo {
	prov := tfbridge.ProviderInfo{
		...
		Repository: "https://github.com/pulumi/pulumi-exoscale",
		...
		Config:    map[string]*tfbridge.SchemaInfo{
			...
			//    EnvVars: []string{"EXOSCALE_MODE"}, // Multiple vars can be used
			//    Value:   "local",
			//  },
			// },
		},
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: path.Join(
				"github.com/pulumi/pulumi-exoscale/sdk",
