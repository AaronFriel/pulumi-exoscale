module github.com/pulumi/pulumi-exoscale/provider

go 1.19

replace (
	github.com/exoscale/terraform-provider-exoscale => ../upstream
...
require (
	github.com/exoscale/terraform-provider-exoscale v0.0.0
